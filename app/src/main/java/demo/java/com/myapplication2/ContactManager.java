...
public class ContactManager {
    public ContactManager(String DisplayName, String MobileNumber, String HomeNumber, String WorkNumber, String emailID, String company, String jobTitle, Context context){
